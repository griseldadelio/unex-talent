export default {
  title: 'Hello world',
  description: 'this is an example for i18n',
  ...
  cardImg: {
    ...
    item1:
      'Understanding the business and understanding the need: definition of target market / profile.',
    ...
    item5:
      'Presentation of candidates to the client. Curriculum vitae plus interview report.',
    item6:
      'Coordinating the interview process between the client and candidates.',
    item7:
      'Feedback meeting / Sharing of information. Validation and adjustments. ',
    item8:
      'Evaluation of the finalist candidate: references, psychometric assessment, occupational health, socio-environmental factors.',
  ...
  us: {
    ...
    text2:
      'Our personalized and proactive way of working makes the job easier for our clients. We are practical in finding the best candidates quickly, efficiently and at competitive costs. We also offer solutions in personnel evaluation and consulting.',
    text3:
      "Each team selector is specialized by industry and functional area, in order to understand the customer's needs in detail. The market is constantly changing, and we accompany this change in a dynamic and innovative way. Our goal is to provide excellent solutions tailored to our customers' needs.",
  },
  search: {
